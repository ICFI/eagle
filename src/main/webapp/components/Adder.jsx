// Examples of Bootstrap input fields
...
class Adder extends Component {
  ...
  render() {
    ...
    return (<div>
      <form>
        <FormGroup controlId="formFieldOne" validationState={this.getValidationFieldOne()}>
          <ControlLabel>Field One</ControlLabel>
          <FormControl type="text" value={this.state.fieldOne} placeholder="Enter Number" onChange={this.handleChangeFieldOne}/>
          <FormControl.Feedback/>
          <HelpBlock>Validation is based on number length.</HelpBlock>
        </FormGroup>
        <FormGroup controlId="formFieldTwo" validationState={this.getValidationFieldTwo()}>
          <ControlLabel>Field Two</ControlLabel>
          <FormControl type="text" value={this.state.fieldTwo} placeholder="Enter Number" onChange={this.handleChangeFieldTwo}/>
          <FormControl.Feedback/>
          <HelpBlock>Validation is based on number length.</HelpBlock>
        </FormGroup>
      </form>
